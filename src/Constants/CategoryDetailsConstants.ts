const CategoryDetails = {
  Breakfast: [
    {
      ...
      image: require('../Assets/BigBreakfast.png'),
      price: 20.0,
      qty: 0,
    },
    {
      ...
      image: require('../Assets/HotCakes.png'),
      price: 25.0,
      qty: 0,
    },
    {
      ...
      image: require('../Assets/SausageBurrito.png'),
      price: 25.0,
      qty: 0,
    },
    {
      ...
      image: require('../Assets/EggMcMuffin.png'),
      price: 25.0,
      qty: 0,
    },
  ],
  Drinks: [
    {
      ...
      image: require('../Assets/CocoCola.png'),
      price: 10.0,
      qty: 0,
    },
    {
  ...
  Desserts: [
    {
      ...
      image: require('../Assets/FlOrea.png'),
      price: 10.0,
      qty: 0,
    },
    {
      ...
      image: require('../Assets/SoftServeHotFudge.png'),
      price: 15.0,
      qty: 0,
    },
    {
      ...
      image: require('../Assets/BrownieHotFudge.png'),
      price: 15.0,
      qty: 0,
    },
    {
      ...
      image: require('../Assets/SoftServe.png'),
      price: 15.0,
      qty: 0,
    },
  ],
  Sides: [
    ...
    },
    {
      ...
      image: require('../Assets/PeriPeriMix.png'),
      price: 15.0,
      qty: 0,
    },
    {
      ...
      image: require('../Assets/McVegPuff.png'),
      price: 15.0,
      qty: 0,
    },
    {
      ...
      image: require('../Assets/ChickenNuggets.png'),
      price: 15.0,
      qty: 0,
    },
  ],
